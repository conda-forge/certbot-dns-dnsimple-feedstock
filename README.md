About certbot-dns-dnsimple-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/certbot-dns-dnsimple-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/certbot-dns-dnsimple-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add certbot-dns-dnsimple
# for installing globally
pixi global install certbot-dns-dnsimple
```
...
It is possible to list all of the versions of `certbot-dns-dnsimple` available on your platform:
...
```
pixi search certbot-dns-dnsimple --channel conda-forge
```
